...
class LinearDecayLR(object):
    def __init__(self, optimizer, last_epoch=-1, nepoch_decay=100):
        """Linear Decay scheduler.
        This does not support the optimizer which has multiple groups of parameters.
        nepoch_decay から学習率を0に向かって線形善水させる．

        Args:
            optimizer (Optimizer): Wrapped optimizer.
            last_epoch (int, optional): Defaults to -1. [description]
            nepoch_decay (int, optional): 何epoch から学習率を線形減衰させるか．Defaults to 100. [description]
        """
        self.optimizer = optimizer
        self.last_epoch = last_epoch
        self.nepoch_decay = nepoch_decay
    ...
    def decay_lr(self, old_lr, initial_lr):
        ...
        """
        lrd = initial_lr / self.nepoch_decay
        return old_lr - lrd
